...
```bash
curl -fsSL https://github.com/nash87/parkhub-docker/releases/latest/download/install.sh | bash
```
...
```bash
# Linux x86_64
wget https://github.com/nash87/parkhub-docker/releases/latest/download/parkhub-server-linux-amd64
...
```powershell
irm https://github.com/nash87/parkhub-docker/releases/latest/download/install.ps1 | iex
```

Or grab `parkhub-server-windows-amd64.exe` from the [releases page](https://github.com/nash87/parkhub-docker/releases).
